...
def benchmark_matrix_multiplication():
    ...
    print("Starting nvmath matrix multiplication benchmarks...")
    for size in sizes:
...
def plot_roofline(results):
    ...
    plt.scatter(ai_measured, gflops_measured, color='teal', marker='o', s=100, edgecolors='black', zorder=5, label='nvmath-python Matrix Multiplication')
    
    # Formatting
    plt.title("Roofline Model - nvmath-python Matrix Multiplication on Tesla V100 GPU", fontsize=14, fontweight='bold')
    ...
    # Save the plot
    plt.tight_layout()
    plt.savefig("roofline_nvmath.png")
    print("Roofline plot saved successfully as 'roofline_nvmath.png'.")
